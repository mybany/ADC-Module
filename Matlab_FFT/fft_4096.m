...
%clear all;
weight_all = 4.1644259838873407e3;
%1.88 4.1644259838873407e3
%1.95 6204.7267239859229;
...
close all;
%DATA = ADResult - 0.5;
DATA_ALL = DATA_ALL - (weight_all / 2);
DATA_ALL = DATA_ALL / weight_all;
DATA = DATA_ALL(95000:99095);
